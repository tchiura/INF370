    ...
    public partial class HomeScreen : Form
    {
        ...
        private void Form4_Load(object sender, EventArgs e)
        {
            ...
            /* SqlConnection conn = new SqlConnection(globalClass.myConn);
             ...
             SqlDataAdapter adapter = new SqlDataAdapter("SELECT SkillDescription from Skill", conn);
             adapter.Fill(ds);
             this.SkillList.DataSource = ds.Tables[0];
             //this.SkillList.DisplayMember = "SkillDescription";
             //skill = ds.Tables[0].AsEnumerable().Select(dataRow => new Skill { SkillDescription = dataRow.Field<string>("SkillDescription") }).ToList();
             //skills = SkillList.DataSource as (List<Skill>);
             conn.Close();*/
